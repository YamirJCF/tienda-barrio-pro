...
onMounted(() => {
  employeesStore.initializeSampleData();
});
</script>
...
<template>
  <div class="flex flex-col h-screen bg-background-light dark:bg-background-dark pb-24">
    ...
    <header class="flex items-center justify-between px-4 py-4 bg-white dark:bg-slate-800 border-b border-gray-100 dark:border-gray-700 shrink-0">
      ...
      <h1 class="flex-1 text-center text-lg font-bold tracking-tight text-gray-900 dark:text-white">Administrar Empleados</h1>
    ...
    <main class="flex-1 overflow-y-auto px-4 pt-4">
      ...
      >
        <div class="flex h-16 w-16 items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800 text-gray-400 mb-4">
