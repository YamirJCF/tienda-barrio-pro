...
watch(() => [props.modelValue, props.employeeId], ([show, employeeId]) => {
  if (show && employeeId) {
...
<template>
  <Teleport to="body">
    <Transition name="modal">
      ...
      >
        <!-- Modal Container -->
        <div class="w-full max-w-md mx-auto bg-white dark:bg-slate-800 rounded-t-2xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden animate-slide-up">
          <!-- Handle -->
          ...
          <div class="overflow-y-auto p-6 space-y-6 flex-1">
            ...
            <div class="space-y-4">
              <div class="space-y-1.5">
                ...
                <div class="relative">
                  <span class="absolute left-3 top-1/2 -translate-y-1/2 material-symbols-outlined text-gray-400 text-[20px]">person</span>
                  <input 
              ...
              <div class="space-y-1.5">
                <label class="text-sm font-medium text-gray-600 dark:text-gray-400">Usuario de Acceso</label>
                <div class="relative">
                  <span class="absolute left-3 top-1/2 -translate-y-1/2 material-symbols-outlined text-gray-400 text-[20px]">badge</span>
                  <input 
            ...
            <!-- Security Section -->
            <div class="p-4 rounded-xl bg-blue-50/50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-800 space-y-3">
              <div class="flex items-center gap-2 text-primary font-medium">
                <span class="material-symbols-outlined text-[20px]">lock</span>
                <span class="text-sm">Seguridad</span>
              </div>
              <div class="space-y-1.5">
                <label class="text-xs font-medium uppercase tracking-wider text-gray-600 dark:text-gray-400">Asignar PIN (4 dígitos)</label>
                <input 
                  :value="formData.pin"
            ...
            <!-- Permissions -->
            <div class="space-y-3">
              <label class="text-sm font-medium text-gray-600 dark:text-gray-400 block">Permisos</label>
              
              <label class="flex items-center gap-3 p-3 rounded-lg border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-700/30 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                <input 
                  v-model="formData.canSell"
                  class="size-5 rounded border-gray-300 text-primary focus:ring-primary" 
                  type="checkbox"
                />
                <span class="text-sm font-medium text-gray-900 dark:text-white">Puede Vender</span>
              </label>
              ...
              <label class="flex items-center gap-3 p-3 rounded-lg border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-700/30 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                <input 
                  ...
                  type="checkbox"
                />
                <span class="text-sm font-medium text-gray-900 dark:text-white">Puede ver Reportes</span>
              </label>
              ...
              <label class="flex items-center gap-3 p-3 rounded-lg border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-700/30 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                <input 
                  ...
                  type="checkbox"
                />
                <span class="text-sm font-medium text-gray-900 dark:text-white">Puede Fiar</span>
              </label>
            </div>
          </div>

          <!-- Modal Actions -->
          <div class="p-6 pt-2 pb-8 flex gap-3 border-t border-gray-100 dark:border-gray-700 bg-white dark:bg-slate-800">
            <button 
              @click="close"
