    ...
    <Transition name="modal">
      <div v-if="modelValue && product" class="fixed inset-0 z-50 flex items-end justify-center bg-gray-800/80"
        ...
        <div
          ...
          <!-- Sell Unit Selector -->
          <div class="p-3 border-b border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900">
            <div class="text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-2 text-center">
              Vender en:
            </div>
