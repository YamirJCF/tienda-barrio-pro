...
<template>
  <Teleport to="body">
    <Transition name="modal">
      <div v-if="modelValue" class="fixed inset-0 z-50 flex items-end justify-center bg-black/40 backdrop-blur-sm"
        @click.self="close">
        <!-- Modal Container -->
        <div
          ...
          <div class="overflow-y-auto p-6 space-y-6 flex-1">
            ...
            <div class="space-y-4">
              <div class="space-y-1.5">
                ...
                <div class="relative">
                  <span
                    class="absolute left-3 top-1/2 -translate-y-1/2 material-symbols-outlined text-gray-400 text-[20px]">person</span>
              ...
              <div class="space-y-1.5">
                ...
                <div class="relative">
                  <span
                    class="absolute left-3 top-1/2 -translate-y-1/2 material-symbols-outlined text-gray-400 text-[20px]">badge</span>
                  <input v-model="formData.username" @input="handleUsernameInput"
                    class="w-full h-12 rounded-lg border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 pl-10 pr-4 text-sm focus:border-primary focus:ring-primary text-gray-900 dark:text-white placeholder-gray-400"
                    placeholder="Número de teléfono o identificación" type="tel" inputmode="numeric" />
                </div>
              </div>
            ...
            <div
              ...
              <div class="space-y-1.5">
                <label class="text-xs font-medium uppercase tracking-wider text-gray-600 dark:text-gray-400">Asignar PIN
                  (4 dígitos)</label>
                <input :value="formData.pin" @input="handlePinInput"
                  ...
                  maxlength="4" inputmode="numeric" placeholder="••••" type="tel" />
            ...
            <div class="space-y-3">
              ...
              <label
                ...
                <span class="text-sm font-medium text-gray-900 dark:text-white">Puede Vender (Por defecto)</span>
              </label>
              ...
              <label
                ...
                <input v-model="formData.canManageInventory"
                  class="size-5 rounded border-gray-300 text-primary focus:ring-primary" type="checkbox" />
                <span class="text-sm font-medium text-gray-900 dark:text-white">Inventario (Acceso Completo)</span>
              </label>

              <label
                class="flex items-center gap-3 p-3 rounded-lg border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-700/30 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                <input v-model="formData.canOpenCloseCash"
                  class="size-5 rounded border-gray-300 text-primary focus:ring-primary" type="checkbox" />
                <span class="text-sm font-medium text-gray-900 dark:text-white">Caja (Abrir/Cerrar)</span>
              </label>
            </div>
          </div>
