        ...
        <div
          ...
          <div class="px-6 pb-4 border-b border-slate-100 dark:border-slate-700">
            <div class="flex items-center justify-between">
              ...
              <button @click="close" class="p-2 rounded-full hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-400">
          ...
          <div class="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            <section v-if="pendingRequests.length > 0">
              <h4 class="text-sm font-bold text-amber-700 dark:text-amber-400 mb-2 flex items-center gap-2">
              ...
              <div class="space-y-2">
                <div v-for="request in pendingRequests" :key="request.id"
                  ...
                  <div class="flex items-start justify-between mb-3">
                    <div>
                      <p class="font-bold text-slate-900 dark:text-white">{{ request.employeeName }}</p>
                      <p class="text-xs text-slate-500 dark:text-slate-400">
                  ...
                  <div class="flex gap-2">
                    <button @click="approveDevice(request)"
                    ...
                    <button @click="rejectDevice(request)"
            ...
            <section v-if="approvedDevices.length > 0">
              ...
              <div class="space-y-2">
                <div v-for="device in approvedDevices" :key="device.id"
                  ...
                  <div>
                    <p class="font-medium text-slate-800 dark:text-slate-200 text-sm">{{ device.employeeName }}</p>
                    <p class="text-xs text-slate-500 dark:text-slate-400">
