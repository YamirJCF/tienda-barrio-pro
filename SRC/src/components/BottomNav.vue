...
<template>
  <nav
    ...
    <div class="grid h-16 max-w-lg mx-auto"
      ...
      <button v-if="showInventory" @click="router.push('/inventory')"
        class="group flex flex-col items-center justify-center gap-1 transition-colors"
      ...
      <button v-if="canViewReports" @click="router.push({ path: '/admin', query: { tab: 'reportes' } })"
        class="group flex flex-col items-center justify-center gap-1 transition-colors"
      ...
      <button v-if="showClients" @click="router.push('/clients')"
        class="group flex flex-col items-center justify-center gap-1 transition-colors"
