  ...
  <div class="min-h-screen bg-gray-900 text-white font-mono">
    ...
    <header class="bg-gray-800 border-b border-gray-700 px-4 py-3">
      <div class="flex items-center justify-between max-w-2xl mx-auto">
        ...
        <div class="text-xs text-gray-500">v1.0 | Emergency Tool</div>
      </div>
    </header>
    ...
    <main class="max-w-2xl mx-auto p-4 space-y-4">
      ...
      <div class="space-y-3">
        <div
          v-for="test in tests"
          :key="test.id"
          class="bg-gray-800 rounded-xl p-4 border border-gray-700 transition-all"
          :class="{
          ...
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1 min-w-0">
              <div class="flex items-center justify-between mb-1">
                ...
                <span v-if="test.duration" class="text-xs text-gray-500"
      ...
      <div class="bg-gray-800/50 rounded-xl p-4 border border-gray-700/50 mt-6">
        <p class="text-xs text-gray-500 leading-relaxed">
          ...
          Esta vista está diseñada para diagnosticar problemas de integridad de datos. No requiere
          autenticación y puede ejecutarse incluso si el sistema de login está roto. Accede siempre
          en <code class="bg-gray-700 px-1 rounded">/sys-audit</code>
        </p>
      </div>
    </main>
  </div>
