  ...
  <div class="flex flex-col h-screen bg-background-light dark:bg-background-dark pb-24 relative">
    ...
    >
      <div class="px-4 py-3 flex items-center gap-3">
        ...
        <button
          class="p-2 rounded-full bg-gray-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300"
        >
    ...
    <main class="flex-1 overflow-y-auto p-4 flex flex-col gap-3 no-scrollbar">
      <div class="flex justify-between items-end px-1">
        ...
        <span
          v-if="inventoryStore.lowStockProducts.length > 0"
      ...
      >
        ...
        >
          <div class="flex justify-between items-start gap-4">
            <div class="flex-1">
              ...
              <div class="flex items-center gap-2 mt-1">
                ...
                <span v-if="product.plu" class="text-slate-400 text-xs font-mono"
                  >PLU: {{ product.plu }}</span
                >
              </div>
              <span
          ...
          <div
            class="flex items-center justify-between pt-2 border-t border-gray-50 dark:border-gray-800"
          >
            <span
              :class="
                product.stock.lte
    ...
    <Teleport to="body">
      <Transition name="modal">
        ...
        >
          ...
          <div
            class="relative w-full max-w-sm bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-6"
          >
