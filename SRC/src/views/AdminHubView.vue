        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div
            ...
            <div class="flex items-start justify-between mb-4">
              ...
              <span class="px-2 py-1 rounded-md text-xs font-bold" :class="salesStore.isStoreOpen
            ...
            <div class="mb-5">
              ...
              <p class="text-sm text-slate-500 dark:text-slate-400 mt-1 font-medium">
                Base inicial: <span class="text-slate-900 dark:text-slate-200 font-bold">$ {{
                  salesStore.openingCash.toDecimalPlaces(0).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".") }}</span>
              </p>
            </div>
            <button @click="navigateTo('/cash-control')"
          ...
          <div
            ...
            <button @click="navigateTo('/expenses')"
          ...
          <div class="flex items-center justify-between gap-4">
            ...
            <button @click="confirmCloseStore"
              ...
              <span
                ...
                :class="isStoreClosed ? 'translate-x-6' : 'translate-x-1'"></span>
            </button>
          </div>
        </div>
      </section>
