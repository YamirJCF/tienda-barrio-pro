...
const differenceColor = computed(() => {
  if (difference.value.greaterThan(0)) return 'text-emerald-600 bg-emerald-50 dark:bg-emerald-900/20'; // Sobrante
  if (difference.value.lessThan(0)) return 'text-red-600 bg-red-50 dark:bg-red-900/20'; // Faltante
  return 'text-gray-600 bg-gray-50 dark:text-gray-300 dark:bg-slate-700'; // Cuadrado
});
